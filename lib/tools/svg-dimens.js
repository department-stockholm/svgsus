  ...
  if (typeof viewBoxAttr === "undefined") {
    if (typeof widthAttr === "undefined" || typeof heightAttr === "undefined") {
      ...
      return {
        x: 0,
        y: 0,
        width: convertDimensionToPx(widthAttr),
        height: convertDimensionToPx(heightAttr)
      };
    }
  } else {
    ...
    var viewBoxAttrParts = viewBoxAttr.split(/[,\s]+/);
    return {
      x: viewBoxAttrParts[0],
      y: viewBoxAttrParts[1],
      width: viewBoxAttrParts[2],
      height: viewBoxAttrParts[3]
    };
  }
}
