...
const inlineStyle = require('./tools/inline-style');

function vectorDrawableParser(inputXml, options = {}) {
  ...
  return substituteRefs(inputXml)
    .then(outputXml => inlineStyle(outputXml))
...
module.exports.convert = vectorDrawableParser;
