...
function convert(inputXml, options = {}) {
  ...
  return substituteRefs(inputXml)
    .then(outputXml => optimizeSvg(outputXml, {
      removeTitle: true,
      removeHiddenElems: stripStyle,
      custom: stripStyle ? [moveGroupPaintToElems, removeInvisiblePaintElems, removePaintAttrs] : false
    }))
